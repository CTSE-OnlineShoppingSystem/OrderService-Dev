    ...
    render() {
        return (
            <div className={"background"}>
                ...
                <Card className={"crd-delivery-tb"}>
                    <Card.Body>
                            <Row>
                                <center><Col  md={4} ><div className={"crd-delivery-title"}>Delivery Details</div></Col></center>
                        ...
                        <div className={"main-div"}>
                            <Form onSubmit={this.addOrder}>
                                <Form.Group controlId={"formCardName"} className={"delivery-grp"}>
                                    ...
                                    <center><Form.Control type={"text"} name={"address"}
                                                  className={"delivery-d-input"}
                                                  required
                                ...
                                <center><Form.Group controlId={"formSubmitBtn"} className={"text-center"}>
